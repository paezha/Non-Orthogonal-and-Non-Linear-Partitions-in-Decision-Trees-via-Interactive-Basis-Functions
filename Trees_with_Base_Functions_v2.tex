...
replications for each (i.e., 4-fold cross-validation). The summary of
the results is shown in Table \ref{tab:summary-benchmarking}, where it
can be seen that random forests outperform evolutionary trees, which in
turn outperform conventional trees. This is as anticipated. Further, for
the same algorithm, the use of IBF increases the average accuracy
slightly, and provides similar results in terms of kappa and the mean
tree size. The experiments were conducted using a parallel
implementation of the code, using 4 Intel i7-6600U cores clocked at 2.60
GHz.
...
\toprule
Method & Base Function & Mean Accuracy (\%) & Mean kappa & Mean Tree Size\\
\midrule
...
\begin{figure}[htbp]
\centering
\includegraphics{Trees_with_Base_Functions_v2_files/figure-latex/fig20-map-basis-newark-1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{Trees_with_Base_Functions_v2_files/figure-latex/fig22-tree-orthogonal-sapporo-1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{Trees_with_Base_Functions_v2_files/figure-latex/fig23-map-orthogonal-sapporo-1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{Trees_with_Base_Functions_v2_files/figure-latex/fig25-map-basis-sapporo-1.pdf}
